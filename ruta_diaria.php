...
::placeholder { font-family: Gotham, sans-serif !important; opacity: 0.6; }
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/python-visualization/folium/folium/templates/leaflet.awesome.rotate.min.css"/>
            ...
            <style>
                #map_0ad5938f68dfecfffb9e5e89eac07839 {
                    position: relative;
                    width: 100.0%;
                    height: 100.0%;
                    left: 0.0%;
...
<body>
    ...
    <style>
        ...
        .leaflet-control-layers-list::before { content: 'ruta'; display: block; margin-bottom: 5px; border-bottom: 1px solid #ccc; font-family:'Saturn-Bold', sans-serif; font-size:14px; color:#011E41; text-transform: lowercase; } 
        .leaflet-control-layers-base { display: none; }
        .leaflet-control-layers { border: 2px solid #011E41 !important; border-radius: 8px !important; color: #011E41 !important; font-family: Gotham, sans-serif; font-weight: bold; }
    </style>
    <div id="mbs-table-container" style="position: fixed; bottom: 0; left: 0; width: 100%; height: 28%; background-color: white; z-index: 9999; overflow-y: auto; box-shadow: 0px -4px 10px rgba(0,0,0,0.1); border-top: 2px solid #011E41;">
        <table style="width: 100%; border-collapse: collapse; font-family: Gotham, sans-serif; font-size: 12px; font-weight: normal; table-layout: fixed;">
            <tbody>
                <tr style="border-bottom: 1px solid #eee; cursor: pointer;" onclick="showNotes(decodeURIComponent('Specialized%20Sirrus%2C%20necesita%20pastillas%20ambas%20ruedas%20y%20camara%20trasera%20pinchada'))">
                    <td style="padding: 4px 2px; color: #007bff; width: 6%; white-space: nowrap; vertical-align: middle;">S1</td>
                    <td style="padding: 4px 2px; width: 10%; white-space: nowrap; vertical-align: middle;">10:00</td>
                    <td style="padding: 4px 2px; width: 23%; font-size: 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 0; vertical-align: middle;">Felipe Besoain Fuhrm</td>
                    <td style="padding: 4px 2px; width: 51%; font-size: 10px; color: #666; white-space: normal; line-height: 1.1; vertical-align: middle;">Espoz 4935  Vitacura</td>
                    <td style="padding: 4px 2px; font-size: 10px; color: #444; width: 10%; white-space: nowrap; text-align: right; vertical-align: middle;">CL1</td>
                </tr>
                
                <tr style="border-bottom: 1px solid #eee; cursor: pointer;" onclick="showNotes(decodeURIComponent('Revisar%20estado%20y%20recomendar%20proceder'))">
                    <td style="padding: 4px 2px; color: #0056b3; width: 6%; white-space: nowrap; vertical-align: middle;">S2</td>
                    <td style="padding: 4px 2px; width: 10%; white-space: nowrap; vertical-align: middle;">12:00</td>
                    <td style="padding: 4px 2px; width: 23%; font-size: 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 0; vertical-align: middle;">Claudio Castillo</td>
                    <td style="padding: 4px 2px; width: 51%; font-size: 10px; color: #666; white-space: normal; line-height: 1.1; vertical-align: middle;">Silvina Hurtado 1807 D 706 Providencia</td>
                    <td style="padding: 4px 2px; font-size: 10px; color: #444; width: 10%; white-space: nowrap; text-align: right; vertical-align: middle;">CL1</td>
                </tr>
                
                <tr style="border-bottom: 1px solid #eee; cursor: pointer;" onclick="showNotes(decodeURIComponent('proforma'))">
                    <td style="padding: 4px 2px; color: #004085; width: 6%; white-space: nowrap; vertical-align: middle;">S3</td>
                    <td style="padding: 4px 2px; width: 10%; white-space: nowrap; vertical-align: middle;">14:00</td>
                    <td style="padding: 4px 2px; width: 23%; font-size: 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 0; vertical-align: middle;">David Barra</td>
                    <td style="padding: 4px 2px; width: 51%; font-size: 10px; color: #666; white-space: normal; line-height: 1.1; vertical-align: middle;">Capitan Orella 2464 D202 Ñuñoa</td>
                    <td style="padding: 4px 2px; font-size: 10px; color: #444; width: 10%; white-space: nowrap; text-align: right; vertical-align: middle;">CL1</td>
                </tr>
                
                <tr style="border-bottom: 1px solid #eee; cursor: pointer;" onclick="showNotes(decodeURIComponent('Tengo%20una%20Bici%20p3.%20El%20tema%20es%20que%20la%20rueda%20de%20atras%20tiene%20un%20problema.%20Al%20principio%20pense%20que%20era%20la%20camara%20o%20tipico%20pinchada.%20Pero%20la%20lleve%20dos%20veces%20a%20un%20taller%20en%20Predisente%20riesco%20y%20se%20volvio%20a%20pinchar%20la%20rueda%20de%20atras.%20Debe%20tener%20un%20problema%20con%20el%20pituto%20para%20inflarLa%20rueda%20de%20adelante%20tambi%C3%A9n%20esta%20pinchadaYo%20quiero%20vender%20la%20bici'))">
                    <td style="padding: 4px 2px; color: #3399ff; width: 6%; white-space: nowrap; vertical-align: middle;">S4</td>
                    <td style="padding: 4px 2px; width: 10%; white-space: nowrap; vertical-align: middle;">16:00</td>
                    <td style="padding: 4px 2px; width: 23%; font-size: 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 0; vertical-align: middle;">Francisca Saieh</td>
                    <td style="padding: 4px 2px; width: 51%; font-size: 10px; color: #666; white-space: normal; line-height: 1.1; vertical-align: middle;">Versalles 2977 D 81 Las Condes</td>
                    <td style="padding: 4px 2px; font-size: 10px; color: #444; width: 10%; white-space: nowrap; text-align: right; vertical-align: middle;">VM</td>
                </tr>
                </tbody>
        </table>
    </div>
    ...
    <div id="notes-modal" onclick="event.stopPropagation()" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); background:white; padding:20px; border-radius:8px; box-shadow:0px 4px 15px rgba(0,0,0,0.3); z-index:100001; min-width:300px; max-width:80%; max-height:80vh; overflow-y:auto; font-family:Gotham, sans-serif; font-size:14px; font-weight:normal; color:#011E41; border: 2px solid #011E41;">
        ...
        <div style="margin-top: 15px; text-align: right;"><button onclick="closeNotes()" style="background:#011E41; color:white; border:none; padding:5px 15px; border-radius:18px; cursor:pointer; font-family:Gotham, sans-serif; font-weight:bold;">Cerrar</button></div>
    </div>
    <script>
    ...
    <div id="wa-modal" onclick="event.stopPropagation()" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); background:white; padding:20px; border-radius:12px; box-shadow:0px 4px 15px rgba(0,0,0,0.4); z-index:100005; width:85%; max-width:380px; font-family:Gotham, sans-serif; max-height:90vh; overflow-y:auto; border: 2px solid #011E41;">
        ...
        <div style="margin-top: 15px; text-align: center;">
            <button onclick="closeWaModal()" style="background:#eee; color:#011E41; border:none; padding:8px 20px; border-radius:18px; cursor:pointer; font-family:Gotham, sans-serif; font-weight:bold; font-size:12px;">Cancelar</button>
        </div>
    </div>
    <script>
        let currentWaData = {};
    ...
    <script>function autoFilter(){const p=new URLSearchParams(window.location.search);const m=p.get('mechanic');if(!m)return;const t=m.toLowerCase();const s=document.querySelectorAll('.leaflet-control-layers-selector');if(s.length===0){setTimeout(autoFilter,300);return}s.forEach(i=>{const l=i.nextElementSibling.innerText.trim().toLowerCase();if((l==='juan'||l==='seba')&&l!==t){if(i.checked)i.click()}})}window.addEventListener('load',autoFilter)</script>
            ...
            <div class="folium-map" id="map_0ad5938f68dfecfffb9e5e89eac07839" ></div>
        
</body>
<script>
    
    
            var map_0ad5938f68dfecfffb9e5e89eac07839 = L.map(
                "map_0ad5938f68dfecfffb9e5e89eac07839",
                {
  ...
  "preferCanvas": false,
            ...
            var tile_layer_a66f87704dd127ea5fd9c2d0b3dc6b2e = L.tileLayer(
  ...
  "opacity": 1,
            ...
            tile_layer_a66f87704dd127ea5fd9c2d0b3dc6b2e.addTo(map_0ad5938f68dfecfffb9e5e89eac07839);
        
    
            var marker_20dc3a4a1ddde77921b524017f5bf436 = L.marker(
                [-33.45219480797122, -70.5787333882418],
                {
}
            ).addTo(map_0ad5938f68dfecfffb9e5e89eac07839);
        
    
        var icon_0d8247650e5007c2be2465851e583b3a = L.icon({
  ...
  "iconSize": [28, 28],
                ...
                marker_20dc3a4a1ddde77921b524017f5bf436.setIcon(icon_0d8247650e5007c2be2465851e583b3a);
            
    
            var feature_group_dc1db745d38b9103081d1f3d6f90f520 = L.featureGroup(
                {
}
            );
        
    
            feature_group_dc1db745d38b9103081d1f3d6f90f520.addTo(map_0ad5938f68dfecfffb9e5e89eac07839);
        
    
            var feature_group_c8a5dc4f0b2676d90e0521d1ab5595bf = L.featureGroup(
                {
}
            );
        
    
            var poly_line_adcfa89750988573ccf9ca9231f51b13 = L.polyline(
                [[-33.452290000000005, -70.57889], [-33.45226, -70.57884], [-33.45224, -70.57851], [-33.45158000000001, -70.57859], [-33.45129000000001, -70.57859], [-33.45094, -70.57858], [-33.449270000000006, -70.57869], [-33.448820000000005, -70.57872], [-33.44834000000001, -70.57875], [-33.4483, -70.57785], [-33.44827000000001, -70.57693], [-33.447720000000004, -70.577], [-33.446490000000004, -70.57716], [-33.445100000000004, -70.57732], [-33.443920000000006, -70.57748], [-33.44286, -70.5776], [-33.44308, -70.57693], [-33.44310000000001, -70.57672], [-33.442910000000005, -70.57496], [-33.44263000000001, -70.5726], [-33.44156, -70.57279], [-33.44037000000001, -70.57300000000001], [-33.43965000000001, -70.57307], [-33.43918000000001, -70.57315], [-33.438750000000006, -70.57325], [-33.438210000000005, -70.57345000000001], [-33.43755000000001, -70.57368], [-33.43667000000001, -70.57383], [-33.4365, -70.57383], [-33.43618000000001, -70.57381], [-33.43558000000001, -70.57383], [-33.434610000000006, -70.57394000000001], [-33.43314000000001, -70.57422], [-33.43142, -70.57449], [-33.431020000000004, -70.57457], [-33.43092000000001, -70.57467], [-33.430690000000006, -70.57472], [-33.43016000000001, -70.57482], [-33.42974, -70.57488000000001], [-33.42934, -70.57505], [-33.428650000000005, -70.57516], [-33.42839000000001, -70.57523], [-33.428110000000004, -70.57525], [-33.42795, -70.57531], [-33.42785000000001, -70.57536], [-33.42741, -70.57566], [-33.42674, -70.57631], [-33.426370000000006, -70.57669], [-33.42573000000001, -70.57726], [-33.42542, -70.57755], [-33.423970000000004, -70.57894], [-33.42336, -70.57947], [-33.42248000000001, -70.58022], [-33.42211, -70.58049], [-33.421510000000005, -70.58092], [-33.420170000000006, -70.5819], [-33.419700000000006, -70.58224], [-33.419540000000005, -70.58234], [-33.41922, -70.58246], [-33.418960000000006, -70.58259], [-33.41825000000001, -70.58292], [-33.41758000000001, -70.58322], [-33.41740000000001, -70.58332], [-33.417100000000005, -70.58345], [-33.416630000000005, -70.58366], [-33.416290000000004, -70.58385], [-33.41566, -70.58418], [-33.41498000000001, -70.58447], [-33.414480000000005, -70.58471], [-33.41364000000001, -70.58511], [-33.41328000000001, -70.58529], [-33.41246, -70.58573], [-33.4121, -70.58588], [-33.411820000000006, -70.58601], [-33.411590000000004, -70.58615], [-33.411280000000005, -70.58626], [-33.41105, -70.58639], [-33.410720000000005, -70.58651], [-33.41039000000001, -70.58666], [-33.41031, -70.58665], [-33.410120000000006, -70.58670000000001], [-33.410000000000004, -70.58675], [-33.40943000000001, -70.58704], [-33.40899, -70.58722], [-33.40888, -70.58725], [-33.408500000000004, -70.58733], [-33.408460000000005, -70.58732], [-33.40838000000001, -70.58726], [-33.408100000000005, -70.58727], [-33.407880000000006, -70.58726], [-33.407450000000004, -70.5871], [-33.40717000000001, -70.58697000000001], [-33.40695, -70.58683], [-33.40663000000001, -70.58663], [-33.406220000000005, -70.58643000000001], [-33.40569000000001, -70.58624], [-33.40522000000001, -70.58617], [-33.40449, -70.5862], [-33.40379000000001, -70.58638], [-33.40355, -70.58647], [-33.40317, -70.58659], [-33.40278000000001, -70.58669], [-33.40176, -70.58695], [-33.39911000000001, -70.58767], [-33.398810000000005, -70.58777], [-33.398030000000006, -70.5881], [-33.39697, -70.58856], [-33.396890000000006, -70.58833], [-33.39640000000001, -70.58689], [-33.39622000000001, -70.58642], [-33.39611000000001, -70.58621000000001], [-33.395860000000006, -70.58589], [-33.395770000000006, -70.58578]],
            ...
            ).addTo(feature_group_c8a5dc4f0b2676d90e0521d1ab5595bf);
        
    
            var marker_9e298944e6ec0fcd0edfc8da42ca727c = L.marker(
  ...
  "className": "empty",
            ...
            var marker_515f6522aee3ea5fdcc0aaaed522306d = L.marker(
            ...
            var div_icon_094a04a9a700d2756dda3db86a0beed4 = L.divIcon({
  ...
  "className": "empty",
                ...
                marker_515f6522aee3ea5fdcc0aaaed522306d.setIcon(div_icon_094a04a9a700d2756dda3db86a0beed4);
            
    
            var marker_763fe9ae3e0bcf02df32ea9f227d1424 = L.marker(
            ...
            var div_icon_3cc32abdfd223ff0955b84c668555aed = L.divIcon({
  "html": "\u003cdiv onclick=\"openWaModal(\u002756989653852\u0027, \u0027Claudio\u0027, \u0027Seba\u0027, \u002712:00\u0027)\" style=\"font-family: Gotham, sans-serif; font-size: 11px; font-weight: bold; background-color: white; padding: 5px 10px; border-radius: 8px; box-shadow: 0px 3px 8px rgba(0,0,0,0.15); white-space: nowrap; display: inline-flex; align-items: center; border: none; color:#011E41; transform:translate(-10%, -50%); pointer-events:auto; cursor:pointer; box-shadow: 0px 4px 10px rgba(0,0,0,0.3); border: 1px solid #ddd;\"\u003e\u003cspan style=\"font-family:Gotham, sans-serif; font-weight:bold;\"\u003eS2 / 12:00 / Claudio Castillo\u003c/span\u003e / \u003cspan style=\"font-family:Gotham, sans-serif; font-weight:normal;\"\u003eSilvina Hurtado 1807\u003c/span\u003e\u003c/div\u003e",
  "className": "empty",
});
        
    
                marker_763fe9ae3e0bcf02df32ea9f227d1424.setIcon(div_icon_3cc32abdfd223ff0955b84c668555aed);
            
    
            var poly_line_d714e9ef78373eb7bdeb4ae53c6bd9fb = L.polyline(
            ...
            var marker_db4b0ff097a2221c10e0842cdf62753d = L.marker(
            ...
            var div_icon_4734bfd82bc879fba0f06aadf782caed = L.divIcon({
  ...
  "className": "empty",
                ...
                marker_db4b0ff097a2221c10e0842cdf62753d.setIcon(div_icon_4734bfd82bc879fba0f06aadf782caed);
            
    
            var marker_e478eb60a0ed67047e0c9b9e45f3b8cc = L.marker(
            ...
            var div_icon_81dbf6cd094ddfa585bc3396ebe0311c = L.divIcon({
  "html": "\u003cdiv onclick=\"openWaModal(\u002756982438122\u0027, \u0027David\u0027, \u0027Seba\u0027, \u002714:00\u0027)\" style=\"font-family: Gotham, sans-serif; font-size: 11px; font-weight: bold; background-color: white; padding: 5px 10px; border-radius: 8px; box-shadow: 0px 3px 8px rgba(0,0,0,0.15); white-space: nowrap; display: inline-flex; align-items: center; border: none; color:#011E41; transform:translate(-10%, -50%); pointer-events:auto; cursor:pointer; box-shadow: 0px 4px 10px rgba(0,0,0,0.3); border: 1px solid #ddd;\"\u003e\u003cspan style=\"font-family:Gotham, sans-serif; font-weight:bold;\"\u003eS3 / 14:00 / David Barra\u003c/span\u003e / \u003cspan style=\"font-family:Gotham, sans-serif; font-weight:normal;\"\u003eCapitan Orella 2464\u003c/span\u003e\u003c/div\u003e",
  "className": "empty",
});
        
    
                marker_e478eb60a0ed67047e0c9b9e45f3b8cc.setIcon(div_icon_81dbf6cd094ddfa585bc3396ebe0311c);
            
    
            var poly_line_6f6a0f48dd32b9e6df074cb711300a6a = L.polyline(
            ...
            var marker_5423bd76c0eb5fc72b26bae69ecfb0db = L.marker(
            ...
            var div_icon_772af6738a9340c510e19ddb495b72b9 = L.divIcon({
  ...
  "className": "empty",
                ...
                marker_5423bd76c0eb5fc72b26bae69ecfb0db.setIcon(div_icon_772af6738a9340c510e19ddb495b72b9);
            
    
            var marker_943bc2640038d69e9725293f3fb5d5f5 = L.marker(
            ...
            var div_icon_937e30f87be6c5b541366aaf5a6bad96 = L.divIcon({
  "html": "\u003cdiv onclick=\"openWaModal(\u002756990910812\u0027, \u0027Francisca\u0027, \u0027Seba\u0027, \u002716:00\u0027)\" style=\"font-family: Gotham, sans-serif; font-size: 11px; font-weight: bold; background-color: white; padding: 5px 10px; border-radius: 8px; box-shadow: 0px 3px 8px rgba(0,0,0,0.15); white-space: nowrap; display: inline-flex; align-items: center; border: none; color:#011E41; transform:translate(-10%, -50%); pointer-events:auto; cursor:pointer; box-shadow: 0px 4px 10px rgba(0,0,0,0.3); border: 1px solid #ddd;\"\u003e\u003cspan style=\"font-family:Gotham, sans-serif; font-weight:bold;\"\u003eS4 / 16:00 / Francisca Saieh\u003c/span\u003e / \u003cspan style=\"font-family:Gotham, sans-serif; font-weight:normal;\"\u003eVersalles 2977\u003c/span\u003e\u003c/div\u003e",
  "className": "empty",
});
        
    
                marker_943bc2640038d69e9725293f3fb5d5f5.setIcon(div_icon_937e30f87be6c5b541366aaf5a6bad96);
            
    
            var poly_line_40e88b7c22978901c986a338f7017fa4 = L.polyline(
                [[-33.419700000000006, -70.59773], [-33.41957000000001, -70.59783], [-33.41939000000001, -70.59791], [-33.41868, -70.59513], [-33.41892000000001, -70.59504], [-33.419000000000004, -70.59498], [-33.420390000000005, -70.59387], [-33.420730000000006, -70.59376], [-33.42134000000001, -70.59357], [-33.421640000000004, -70.5935], [-33.421780000000005, -70.59344], [-33.42186, -70.59338], [-33.42193, -70.59332], [-33.42262, -70.59243000000001], [-33.42325, -70.59309], [-33.423860000000005, -70.59379], [-33.42391000000001, -70.59372], [-33.42466, -70.59276], [-33.42549, -70.59169], [-33.42631000000001, -70.59065], [-33.42777, -70.5888], [-33.42869, -70.5876], [-33.42983, -70.5864], [-33.430400000000006, -70.58575], [-33.430460000000004, -70.58565], [-33.43057, -70.58539], [-33.431450000000005, -70.58459], [-33.43177000000001, -70.5843], [-33.431990000000006, -70.58403], [-33.43269000000001, -70.58336], [-33.43314000000001, -70.58294000000001], [-33.433330000000005, -70.58272], [-33.433640000000004, -70.58222], [-33.43410000000001, -70.58253], [-33.43493000000001, -70.58323], [-33.435770000000005, -70.58397000000001], [-33.436510000000006, -70.58464000000001], [-33.437050000000006, -70.58511], [-33.438680000000005, -70.58656], [-33.439550000000004, -70.58731], [-33.43976000000001, -70.5868], [-33.440690000000004, -70.58457], [-33.441050000000004, -70.58367], [-33.44136, -70.58285000000001], [-33.441610000000004, -70.58222], [-33.44180000000001, -70.58172], [-33.44202000000001, -70.58073], [-33.44234000000001, -70.57945], [-33.442440000000005, -70.57914], [-33.442750000000004, -70.57912], [-33.44352000000001, -70.57907], [-33.44467, -70.57901], [-33.44834000000001, -70.57875], [-33.45073000000001, -70.57859], [-33.45143, -70.5786], [-33.451660000000004, -70.57858], [-33.45224, -70.57851], [-33.452220000000004, -70.57813], [-33.452220000000004, -70.57809], [-33.45223000000001, -70.57805], [-33.45228, -70.57801], [-33.452540000000006, -70.57798], [-33.45317000000001, -70.5779], [-33.45313000000001, -70.57846], [-33.453100000000006, -70.57885], [-33.453030000000005, -70.57886], [-33.45233, -70.57891000000001], [-33.45232000000001, -70.57891000000001]],
            ...
            var marker_d96f23b7946489cdf2e6b3b5e97bfd24 = L.marker(
                [-33.43493000000001, -70.58323],
                {
}
            ).addTo(feature_group_c8a5dc4f0b2676d90e0521d1ab5595bf);
        
    
            var div_icon_194f39a4d9ede150b38048066aa7d77c = L.divIcon({
  "html": "\u003ca href=\"https://waze.com/ul?ll=-33.45219480797122,-70.5787333882418\u0026navigate=yes\" target=\"_blank\" style=\"text-decoration:none;\"\u003e\u003cdiv style=\"font-family: Gotham, sans-serif; font-size: 11px; font-weight: bold; background-color: white; padding: 5px 10px; border-radius: 8px; box-shadow: 0px 3px 8px rgba(0,0,0,0.15); white-space: nowrap; display: inline-flex; align-items: center; border: none; color:#8A9892; transform:translateY(-20px); font-family:Gotham, sans-serif;\"\u003e\u003cimg src=\"waze.png\" style=\"width:16px; margin-right:5px;\"\u003eS5 / Base / 20 min\u003c/div\u003e\u003c/a\u003e",
  "className": "empty",
});
        
    
                marker_d96f23b7946489cdf2e6b3b5e97bfd24.setIcon(div_icon_194f39a4d9ede150b38048066aa7d77c);
            
    
            feature_group_c8a5dc4f0b2676d90e0521d1ab5595bf.addTo(map_0ad5938f68dfecfffb9e5e89eac07839);
        
    
            var layer_control_a0054459973b268e2b42976bfec5dd9a_layers = {
                base_layers : {
                },
                overlays :  {
                    "Juan" : feature_group_dc1db745d38b9103081d1f3d6f90f520,
                    "Seba" : feature_group_c8a5dc4f0b2676d90e0521d1ab5595bf,
                },
            };
            let layer_control_a0054459973b268e2b42976bfec5dd9a = L.control.layers(
                layer_control_a0054459973b268e2b42976bfec5dd9a_layers.base_layers,
                layer_control_a0054459973b268e2b42976bfec5dd9a_layers.overlays,
                {
  "position": "topright",
  "collapsed": false,
  "autoZIndex": true,
            ...
            map_0ad5938f68dfecfffb9e5e89eac07839.fitBounds(
                [[-33.47926700000001, -70.61557], [-33.39479, -70.57248]],
                {}
            );
